<template>
<div class="row m-0 p-4 overflow-auto" style="height:100%">
    <div v-if="loading" class="col-md-12 p-5">
        <div class="d-flex justify-content-center align-self-center">
            <pulse-loader :color="`#BF7F25`" :size="`15px`"></pulse-loader> 
        </div>
    </div>  
    <div v-if="!loading" class="col-12 p-0">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div v-for="(pic,index) in previewData[currentColor].images" :key="`pic`+index" :class="(index==0)?`carousel-item active`:`carousel-item`">
                <img class="img img-fluid mt-2 d-block w-100" :src="`/storage/products/`+pic.p_image" style="cursor:pointer" alt="...">
            </div>
        </div>
